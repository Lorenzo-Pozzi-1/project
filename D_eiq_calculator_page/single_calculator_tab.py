...
from E_common import GENERIC_TABLE_STYLE, ContentFrame
from G_data import ProductRepository
from D_eiq_calculator_page.widgets import ProductSelectionWidget, ApplicationParamsWidget, EiqResultDisplay
