...
from D_eiq_calculator_page.widgets.product_selection import (
    ProductSearchField, ProductTypeSelector, ProductSelectionWidget
)

from D_eiq_calculator_page.widgets.application_params import (
    ApplicationRateWidget, ApplicationParamsWidget
)

from D_eiq_calculator_page.widgets.result_display import (
    ColorCodedEiqItem, EiqResultDisplay, EiqComparisonTable
)

from E_common.styles import (
