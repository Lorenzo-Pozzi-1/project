...
from common import create_button, get_title_font, ContentFrame, get_config
...
class ScenarioTabPage(QWidget):
    ...
    def setup_ui(self):
        ...
        applications_layout.addWidget(QLabel("Applications", font=get_title_font(get_subtitle_font_size())))
