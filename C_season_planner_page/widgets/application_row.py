...
from E_common import DRAGGING_ROW_STYLE, FRAME_STYLE, REMOVE_BUTTON_STYLE
from F_math_module import calculate_product_field_eiq, APPLICATION_RATE_CONVERSION
