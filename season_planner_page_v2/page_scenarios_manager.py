"""
Scenarios Manager Page for Season Planner V2.
...
class ScenariosManagerPage(QWidget):
    ...
    This page serves as the main interface for the Season Planner V2 feature,
    ...
    def setup_ui(self):
        ...
        header = HeaderWithHomeButton("Season Planner V2 - Scenarios")
    ...
    def add_new_scenario(self, scenario=None):
        ...
        # Create tab page using V2 interface
